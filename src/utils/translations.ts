      ...
      about: {
        ...
        capabilities: {
          ...
          mechanical: {
            ...
            description:
              "Mechanical structures, mechanisms, hardware selection and practical considerations for manufacturability and assembly.",
          },
    ...
    */
    ...
    about: {
      ...
      */
      ...
      description:
        "我的创作处于设计、工程与视觉艺术的交汇地。",

      introText:
        "我喜欢从一个草图或模糊的概念开始，寻找参考、研究材料与结构、发展造型、建立 3D 模型、制作原型，并最终把它变成一个看得见、摸得着，同时真正能够工作的实体。",
      ...
      */
      ...
      identity: {
        ...
        text:
          "我注重美感，但同时也希望理解一个东西是如何工作的、如何被制造出来，以及不同领域的技术如何被组合成一个完整的产品。",
      ...
      */
      ...
      dossier: {
        ...
        focus:
          "工业设计、嵌入式系统、电子、电工基础、原型制作、视觉表达与实验性创作。",
      },
      ...
      */
      ...
      philosophy: {
        ...
        text:
          "设计从来不是闭门造车。学习已经存在的知识，研究前人的作品，寻找优秀的参考，并把这些已经积累下来的知识与想法重新组合成自己的东西。",

        second:
          "我很享受把不同领域的知识连接起来的过程。一个概念可以来自绘画与视觉设计，造型可以通过 CAD 实现，结构可以通过机械知识解决，最后再通过电子系统和制造技术让它真正运行起来。",
        ...
        mottoText:
          "不是假装自己已经什么都会，而是愿意进入自己并不熟悉的领域，学习实现它所需要的知识，然后不断尝试，直到最初的想法真正成为现实。",
      },
      ...
      */
      ...
      approach: {
        ...
        header:
          "CREATIVE_PIPELINE // IDEA_TO_OBJECT",

        title:
          "IDEA → OBJECT",

        description:
          "从一个模糊的想法开始，逐渐让它拥有形状、结构、功能，并最终成为一个真实存在的东西。",
      ...
      */
      ...
      capabilities: {
        ...
        mechanical: {
          ...
          description:
            "机械结构、机构、五金件选择，以及可制造性、安装与实际落地方面的考虑。",
        },
        ...
        electronics: {
          ...
          description:
            "电工基础、电子系统、Arduino、ESP32，以及将电子元件整合进实体产品。",
        },
        ...
        software: {
          ...
          description:
            "SolidWorks、KeyShot、Photoshop、Clip Studio Paint，以及过去使用 Blender 的经验。",
        },
      ...
      */
      ...
      journey: {
        ...
        text:
          "我的起点并不是工业设计。我最开始接触的是硬件工程，但后来发现自己更希望进入一个能够同时容纳技术思维与视觉创造的领域。",

        second:
          "工业及产品设计最终成为了一个很自然的交汇点：造型、功能、材料、制造与视觉表达，都能够在同一个设计过程中发生。",

        third:
          "而现在，我又在逐渐向技术方向靠近。电子、嵌入式系统、机械结构、材料测试与制造，正在越来越多地进入我的学习与个人项目。",

        fourth:
          "我并不希望自己成为一个需要记住每一个元件参数的纯技术专家。我更感兴趣的是理解不同技术之间如何协作，以及如何把它们组合成一个完整、可使用的产品。",
      },
      ...
      */
      ...
      current: {
        ...
        ai:
          "AI 辅助创作与技术工作流，让 AI 负责实现层面的辅助，同时把审美、判断与方向仍然掌握在人手中。",
      },
      ...
      */
      ...
      future: {
        ...
        text:
          "我希望工业设计继续作为自己的主要职业方向，同时继续发展 Maker 与插画师这两个身份。",

        second:
          "长期来看，我希望自己能够越来越完整地把一个想法从概念与视觉开发，一路做到电子、软件、机械结构、采购与制造，最终成为一个真正完成的实体原型。",
