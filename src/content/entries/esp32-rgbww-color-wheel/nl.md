...
De ESP32 serveert een responsieve kleurbesturingspagina. Gebruikers kunnen elke kleur selecteren uit het wiel of afzonderlijke kanalen aanpassen, en de FCOB-strip update onmiddellijk. Het RGB→RGBW-algoritme produceert schone kleuren met onafhankelijke warmwitbesturing.

Dit is een van die projecten waarbij het resultaat onevenredig afgewerkt aanvoelt voor de hoeveelheid hardware die erin zit: het is gewoon een ESP32 en een LED-strip, maar de webinterface laat het als een echt product aanvoelen. Het kleurenwiel is bevredigend in gebruik, de scènes zijn leuk om te demonstreren, en de witextractie zorgt ervoor dat pastels en warme tinten er echt goed uitzien in plaats van vaal. Het is het soort ding waar ik op blijf terugkomen: meer scènes toevoegen, misschien MQTT-ondersteuning, misschien Home Assistant-integratie. Maar voor nu doet het precies wat ik wilde: een kleur kiezen, hem op de strip zien, geen apps nodig.
